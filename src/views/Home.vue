<template>
  <div class="home ">
    ...
    <!-- <button @click="setdata">重置数据</button> -->
    <Bgdd></Bgdd>
    <Foopview :banners="banners"></Foopview>
    <SnapUp :shoppings="shoppings"></SnapUp>
    <Book :shoppings="shoppings"></Book>
    <Fz></Fz>
    <SortA></SortA>
    <SortB></SortB>
    <SortC></SortC>
    ...
    <div class="list">
      <ul>
        <li @click="goInfo(item.id)"
            class="aa"
            v-for="item in shoppings"
            :key="item.id">
          <img :src="item.url"
               alt="">
          <p class="tip"><a href="javascript:;">{{item.tip}}</a></p>
          <p class="price"><span>¥ {{item.afterprice}}</span><span> {{item.beforeprice}}</span></p>
...
<script>
import SortA from '../views/sort/SortA.vue'
import SortB from '../views/sort/SortB.vue'
import SortC from '../views/sort/SortC.vue'
import Book from "./home/Book.vue"
import Fz from "../views/home/Fz.vue"
import SnapUp from "../views/home/SnapUp.vue"
import Foopview from "../views/home/Loopview.vue"
import Bgdd from "../views/home/Bgdd.vue"
export default {
  ...
  data () {
    return {
      ...
      banners: [
        {
          id: 1,
          isrc: require("../assets/images/202204131815152420.jpg"),
          ihref: "#"
        },
        {
          id: 2,
          isrc: require("../assets/images/2022041317593866330.jpg"),
          ihref: "#"
        },
        {
          id: 3,
          isrc: require("../assets/images/2022041318001212384.jpg"),
          ihref: "#"
        },
        {
          id: 4,
          isrc: require("../assets/images/2022041217394566596.jpg"),
          ihref: "#"
        },
        {
          id: 5,
          isrc: require("../assets/images/2022041318004269913.jpg"),
          ihref: "#"
        },
        {
          id: 6,
          isrc: require("../assets/images/2022041318011229465.jpg"),
          ihref: "#"
        }
      ],
  ...
  methods: {
    goInfo (res) {
      ...
      // this.bus.$emit('homeInfo', this.shoppings);
      // 根据id变量数组      // 利用json
      sessionStorage.setItem("shoppings", JSON.stringify(this.shoppings));
